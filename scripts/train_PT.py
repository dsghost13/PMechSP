...
# raw dataset
df = pd.read_csv('/data/homezvol0/petertl2/PMechSP/datasets/10k_Proton_Transfer.csv')
...
for epoch in range(num_epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), f"/data/homezvol0/petertl2/PMechSP/models/PT/PT_{epoch + 1}.pt")
    else:
        counter += 1
        if counter >= patience:
